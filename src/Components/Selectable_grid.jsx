...
const Selectable_grid = ({ rows = 10, cols = 10 }) => {
  ...
  return (
    <section style={{ display: "flex", gap: "60px" }}>
      <div
        className="grid"
      ...
      <div style={{ display: "block" }}>
        <p className="array__">Array : [{selectedBoxes.join(", ")}]</p>
        <p className="array__"> Comma-separated : {selectedBoxes.join(", ")}</p>
      </div>
    </section>
  );
};
